                ...
                <?php
                   ...
                   $query  = "select productName,Price,productId from products where productId = 7";
                    ...
                    $price = $row['Price'];
                             ...
                             ?>
                             <strong><a href="./products.php?productId=<?php echo $row['productId']?>" name="add1" value="add">Add to watch list</a></strong>
                        ...
                        <?php
                            ...
                            if(isset($_GET['productId']))
                            {
                                ...
                                <script>
                                    alert("You item has been added to the watch list");
                                </script>
...
$_SESSION['prod'] = $product;
                             ...
                             ?>
                             <strong><a href="./products.php?productId=<?php echo $row['productId']?>" name="add">Add to watch list</a></strong>
                        <?php
                        }
